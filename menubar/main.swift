...
let L10N: [String: [String: String]] = [
    ...
    "errLocked":    ["en": "Fan control locked — restart Mac to restore",
                     "zh": "风扇控制被系统锁定 · 重启 Mac 可恢复",
                     "ja": "ファン制御ロック中 · 再起動で復旧",
                     "ko": "팬 제어 잠김 · 재시동으로 복구",
                     "es": "Control bloqueado — reinicie el Mac",
                     "fr": "Contrôle verrouillé — redémarrez le Mac",
                     "de": "Lüftersteuerung gesperrt — Mac neu starten",
                     "ru": "Управление заблокировано — перезагрузите Mac"],
    "errYield":     ["en": "System holds fan control · auto-resumes",
                     "zh": "系统暂时接管风扇 · 稍后自动恢复",
                     "ja": "システムがファン制御中 · 自動再開",
                     "ko": "시스템이 팬 제어 중 · 자동 재개",
                     "es": "El sistema controla el ventilador · se reanudará",
                     "fr": "Système aux commandes · reprise auto",
                     "de": "System steuert Lüfter · setzt autom. fort",
                     "ru": "Система удерживает вентилятор · возобновится"],
